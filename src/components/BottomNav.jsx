...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-bg-secondary/90 backdrop-blur-md border-t border-border/40 flex justify-around items-center py-1.5 px-2 lg:hidden shadow-lg pb-safe">
      ...
      <Link to="/search" className={`flex flex-col items-center text-[9px] font-bold uppercase tracking-wider py-1.5 px-3 rounded-lg transition-all active:scale-95 ${isActive('/search') ? 'text-accent-blue bg-accent-blue/5' : 'text-text-muted'}`}>
        <span className="text-base mb-0.5">🔍</span>
        <span>SEARCH</span>
      </Link>
