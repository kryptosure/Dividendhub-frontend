      ...
      {result && (
        <div className="space-y-4">
          ...
          <div className="text-text-muted text-xs">
            * Dividends are per share as declared, multiplied by the quantity held since purchase.
            Buy price is the close on the last trading day on or before the purchase date.
          </div>
        </div>
      )}
    </div>
